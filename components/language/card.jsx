...
export default function LangCards(props) {
  ...
  useEffect(() => {
    ...
    textt = textt.replace(
      /\*\*(.*?)\*\*/g,
      '<strong class="text-[#30B1C0]">$1</strong>'
    );
      ...
      <div className="w-[175px] h-full flex flex-col justify-center items-center relative ">
        {props.data.image.data != null && props.data.image.data != undefined ? (
          ...
          <Image
            ...
            width={1000}
            height={1000}
            className="object-cover rounded-l-[10px] h-[100%] w-[175px]"
            alt=""
          ></Image>
        )}
      </div>
      <div
        className="w-[695px] py-[8px] text-[14px] leading-[25px] h-[210px] overflow-hidden "
